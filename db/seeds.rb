...
fishing = Hobby.create(name: "Fishing", category: "Outdoor", description: "Year round fun in practially any climate! All you need are these tools and a good fishing spot!", created_by: User.first.username)
...
bird_watching = Hobby.create(name: "Bird Watching", category: "Outdoor", description: "The best and most humane way to connect with wildlife in your own community!", created_by: User.last.username)
...
electric_guitar = Hobby.create(name: "Electric Guitar", category: "Music", description: "An easy and relatively cheap instrument to start learning. You can even play exclusively through headphones!", created_by: User.all[2].username)
...
painting = Hobby.create(name: "Painting", category: "Arts and Crafts", description: "Not only do you get to relax and unwind with this hobby, you can hang your artwork in your house when you're done!", created_by: User.last.username)
...
pastry_making = Hobby.create(name: "Pastry Making", category: "Food and Beverage", description: "With a little bit of practice, you'll never need to buy a pastry again!", created_by: "Admin")
...
brewing_beer = Hobby.create(name: "Beer Brewing", category: "Food and Beverage", description: "Why pay too much money for OK beer when you can make it yourself! The best part about this hobby is it always ends with a drink!", created_by: User.all[1].username)
